  ...
  return (
    <main className="bg-slate-50/50 min-h-screen">
      <PageHero
        ...
        descriptionEn="The latest industry intelligence on smart parking monetization, computer vision LPR, and Egyptian proptech trends."
        descriptionAr="أحدث التحليلات والتقارير حول تسييل مواقف السيارات، وتقنيات التعرف على اللوحات، والابتكارات العقارية في مصر."
